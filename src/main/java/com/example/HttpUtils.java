...
//			httpPost.setHeader("User-Agent", "Mozilla/4.0 (compatible; MSIE 5.0; Windows NT; DigExt)");
    ...
    public static String doPostSSLByCookie(String url, String bodyJson,Map<String,String> headerParams,String cookieName,String cookieValue,String path,String domain) {
        String body = "";
        try {
            CloseableHttpClient client = HttpClients.custom().setConnectionManager(getHttpsConnectionManager()).build();
            HttpPost httpPost = new HttpPost(url);
            ...
            sb.append("=").append(cookieValue).append(";").append("path").append("=").append(path).append(";")
    ...
    public static String doGetSSLByCookie(String url,Map<String,String> headerParams,String cookieName,String cookieValue,String path,String domain){
        String body = "";
        try {
            CloseableHttpClient client = HttpClients.custom().setConnectionManager(getHttpsConnectionManager()).build();
            HttpGet httpGet = new HttpGet(url);
